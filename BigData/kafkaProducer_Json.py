...
train_obj={}
key_x={}
with open("C:\Projects\machine_learning\Rec-Eng\Kafka_poc\Receng") as jdata:
    ...
    if obj["leaf"]:
        ...
        for i in arr:
            ...
            for j in i:
                ...
                count+=1
                producer.send("Rec_engine", {"vector_x":vector,"vector_y":vector_y})
                # print("vector::"+str(vector))
                # print("vector_y:::"+str(vector_y[j,:]))
