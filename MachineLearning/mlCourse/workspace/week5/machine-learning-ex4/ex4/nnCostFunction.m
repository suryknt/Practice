...
J=sum(sum(-y_mat.*log(a3)-(ones(m,num_labels)-y_mat).*log(ones(m,num_labels)-a3)))/m;
...
grad_reg1=lambda*Theta1;
grad_reg2=lambda*Theta2;
grad_reg1(:,1)=0;
grad_reg2(:,1)=0;

Theta1_grad=D1+grad_reg1/m;
Theta2_grad=D2+grad_reg2/m;
